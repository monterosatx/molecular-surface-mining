...
target_pcd, target_desc, target_iface, target_mesh = load_protein_pcd(target_ppi_pair_id, target_chain_ix, target_paths, flipped_features=False, read_mesh=True)
...
for site_ix, site_vix in zip(site_ixs,site_vixs):
    ...
    target_patch, target_patch_descs, target_patch_idx = \
                get_patch_geo(target_pcd,target_coord,site_vix,\
                        target_desc, flip_normals=False, outward_shift=params['surface_outward_shift'])
